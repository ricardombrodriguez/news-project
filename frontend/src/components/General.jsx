    ...
    <div className="flex lg:flex-row justify-between gap-12 md:flex-col">
      ...
      <div className="flex flex-col w-2/5 justify-between">
        <div>
          <Link to={`/detailes`}>
            <Header>
              A Freshman Republican in Oklahoma Makes the Case for Big Spending
              Cuts
            </Header>
            <NewsText>
              Representative Josh Brecheen’s calls for a debt showdown reflects
              how the party has linked its spending fight with cultural battles.
              Representative Josh Brecheen’s calls for a debt showdown reflects
              how the party has linked its spending fight with cultural battles.
            </NewsText>
          </Link>
